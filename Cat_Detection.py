...
def save_to_db(camera):
    ...
    #add images
    for row in range(1,len(os.listdir("Gatos2"))+1):
        worksheet.insert_image(f'A{row+1}', f"Gatos2/gato{row}.png", {'x_scale': 0.1, 'y_scale': 0.1, 'object_position': 2})
